...
def show_menu():
    ...
    print("   Main Menu")
    print("---------------------------")
    print("1. Operating system info")
    print("2. Hostname and dns info")
    print("3. Network info")
    print("4. Who is online")
    print("5. Last logged in users")
    print("6. Free and used memory info")
    print("7. PCAP file information")
    print("8. System info")
    print("9. account activities")
    print("10. list disks details")
    print("11. process_analysis")

    print("12. files and folders")
...
def main():
    while True:
        show_menu()
        option = int(input("Enter your choice [1-13]: "))
        if option == 1:
            ...
            print("Free and used memory info")
